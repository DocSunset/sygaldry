\page page-sygaldry-bindings-portable-osc_match_pattern OSC Address Pattern Matching
...
```cpp
// @#'sygaldry-bindings-portable-osc_match_pattern.test.cpp'
/*
...
#include "sygaldry-bindings-portable-osc_match_pattern.hpp"

@{tests}
// @/

// @#'sygaldry-bindings-portable-osc_match_pattern.hpp'
#pragma once
/*
Copyright 2023 Travis J. West, https://traviswest.ca, Input Devices and Music
Interaction Laboratory (IDMIL), Centre for Interdisciplinary Research in Music
...
// @#'sygaldry-bindings-portable-osc_match_pattern.cpp'
/*
Copyright 2023 Travis J. West, https://traviswest.ca, Input Devices and Music
Interaction Laboratory (IDMIL), Centre for Interdisciplinary Research in Music
Media and Technology (CIRMMT), McGill University, Montréal, Canada, and Univ.
...
```cmake
# @#'CMakeLists.txt'
set(lib sygaldry-bindings-portable-osc_match_pattern)
