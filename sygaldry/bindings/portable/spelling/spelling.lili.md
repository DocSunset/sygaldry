...
defined in \ref sygaldry-helpers-metadata and \ref sygaldry-concepts-metadata
...
```cpp
// @#'sygaldry-bindings-portable-spelling.test.cpp'
#include <string_view>
#include <array>
...
```cpp
// @#'sygaldry-bindings-portable-spelling.hpp'
#pragma once
#include <array>
#include "sygaldry-utilities-consteval.hpp"
...
```cmake
# @#'CMakeLists.txt'
set(lib sygaldry-bindings-portable-spelling)
