\page page-sygaldry-bindings-portable-test_component Bindings Test Component
...
```cpp
// @#'sygaldry-bindings-portable-test_component.hpp'
#pragma once
/*
...
```cmake
# @#'CMakeLists.txt'
set(lib sygaldry-bindings-portable-test_component)
