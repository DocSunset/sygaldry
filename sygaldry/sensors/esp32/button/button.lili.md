\page page-sygaldry-sensors-esp32-button ESP32 Button
...
```cpp
// @#'sygaldry-sensors-esp32-button.hpp'
#pragma once
/*
Copyright 2023 Travis J. West, https://traviswest.ca, Input Devices and Music Interaction Laboratory
(IDMIL), Centre for Interdisciplinary Research in Music Media and Technology
...
#include "sygaldry-sensors-portable-button.hpp"
...
```cpp
// @#'sygaldry-sensors-esp32-button.test.cpp'
/*
Copyright 2023 Travis J. West, https://traviswest.ca, Input Devices and Music Interaction Laboratory
(IDMIL), Centre for Interdisciplinary Research in Music Media and Technology
(CIRMMT), McGill University, Montréal, Canada, and Univ. Lille, Inria, CNRS,
...
```cmake
# @#'CMakeLists.txt'
set(lib sygaldry-sensors-esp32-button)
add_library(${lib} INTERFACE)
target_include_directories(${lib} INTERFACE .)
target_link_libraries(${lib} INTERFACE sygaldry-sensors-portable-button)
target_link_libraries(${lib} INTERFACE sygaldry-sensors-esp32-gpio)
