...
if (ESP_PLATFORM)
    ...
    add_library(sygsa INTERFACE)
        ...
        target_link_libraries(sygsa INTERFACE sygsa-trill_craft)
                    add_subdirectory(sygaldry/sygsa-delay)
        target_link_libraries(sygsa INTERFACE sygsa-delay)
        ...
        target_link_libraries(sygse INTERFACE sygse-gpio)
                    add_subdirectory(sygaldry/sygsa-icm20948)
        target_link_libraries(sygse INTERFACE sygsa-icm20948)
