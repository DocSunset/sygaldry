...
if (ESP_PLATFORM)
    ...
    add_library(sygsa INTERFACE)
        ...
        target_link_libraries(sygse INTERFACE sygse-trill)
                    add_subdirectory(sygaldry/sygsa-max17055)
        target_link_libraries(sygsa INTERFACE sygsa-max17055)
                    add_subdirectory(sygaldry/sygse-max17055)
        target_link_libraries(sygse INTERFACE sygse-max17055)
